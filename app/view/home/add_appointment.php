...
<div class="container flex-wrap justify-content-center">
    ...
    <div class="wrapper">
        ...
        <div class="alert alert-success"> Appointment taken successfully
            <a href="<?php echo $googleOauthURL; ?>"> Export on your Google Calendar </a>
        </div>
        <?php } ?>
        ...
        <div class="col-6">
            <form method="post" class="form">
                <div class="form-group">
                    ...
                    <input type="text" id="name" class="form-control" name="client_name" value="<?php echo !empty($postData['client_name'])?$postData['client_name']:''; ?>" required="">
                </div>
                <div class="form-group">
                    <label for="lawyer">Lawyer Area:</label><br>
                <select id="area" name="law_area" class="form-select my-3">
                    <?php
                ...
                <div class="form-group">
                    ...
                    <select id="lawyer" name="lawyer" class=" form-select my-3">
                        <?php
                ...
                <div class="form-group">
                    ...
                    <input id="date" type="date" class="form-control" name="date" value="<?php echo !empty($postData['date'])?$postData['date']:''; ?>" required="">
                </div>
                <div class="form-group">
                    <label for="time">Time</label>
                    <input type="time" id="time_from" class="form-control" name="time_from" value="<?php echo !empty($postData['time_from'])?$postData['time_from']:''; ?>" >
                    <span>TO</span>
                    <input type="time" id="time_to"  class="form-control" name="time_to" value="<?php echo !empty($postData['time_to'])?$postData['time_to']:''; ?>" >
                </div> <br>
                <div class="form-group">
                    <input type="submit" onclick="sendForm(this)" class="btn btn-primary" name="submit" value="Add Appointment">
                </div>
            </form>
        </div>
    </div>
...
<script>
    function sendForm(e){
        ...
        fetch('http://localhost/api/appointmentAdd', {
            method: 'POST',
