...
if (isset($_POST['register_lawyer'], $_POST['name'], $_POST['email'], $_POST['law_area'])){
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Eighth navbar example">
        <div class="container">
            <a class="navbar-brand" href="/">Law Firm Logo</a>
    ...
    <div class="container d-flex flex-wrap justify-content-center">
        ...
        <form class="mb-3" id="Form" method="POST">
            ...
            <label class="form-label" for="law area"> Law area:</label><br>
            ...
            <input class="btn btn-primary" name="register_lawyer" type="submit" value="Register">
        </form>
