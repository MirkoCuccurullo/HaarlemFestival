...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="<?php echo $artist->picture; ?>" alt="artist picture" style="height: 250px; width: 250px;"
                 class="img-fluid m-3">
        </div>
        <div class="col-md-6">
            <p>
        ...
        <div>
            ...
            ?>
            <iframe class="m-3" style="border-radius:12px; width: 35%"
                    src="https://open.spotify.com/embed/artist/<?= $artist_spotify_code ?>?utm_source=generator&theme=0"
            ...
            <div class="card m-3 border-light">
                <div class="row m-2">
                    ...
                    foreach ($scheduledEvents as $scheduledEvent) {
                        $venue = $scheduledEvent->getVenue();
                        $soldTickets = $scheduledEvent->getSoldTickets();
                        $soldOut = false;
                        if ($soldTickets >= $venue->capacity)
                            $soldOut = true;
                        ?>
                        <div class="col-4">
                            ...
                            <p>
                                From <?php echo $scheduledEvent->start_time; ?>
                                to <?php echo $scheduledEvent->end_time; ?>
                            </p>
                            <p>
                            ...
                            <form method="post" action="/shoppingCart/add">
                                ...
                                if ($soldOut)
                                    ...
                                    echo "btn btn-primary"; ?>" name="addDanceEvent" <?php if ($soldOut)
                                    echo "disabled"; ?>><?php if ($soldOut)
                                        echo "Sold out";
                                    else
