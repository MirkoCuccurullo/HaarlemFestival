...
--
-- Host: mysql
-- Generation Time: Mar 15, 2023 at 09:16 AM
...
CREATE TABLE `reservation` (
                               ...
                               `numberOfUnder12` int(11) DEFAULT NULL,
...
INSERT INTO `restaurant` (`id`, `name`, `description`, `address`, `cuisines`, `dietary`, `photo`) VALUES
    (1, 'Restaurant ML', 'Restaurant ML is located in the heart of the charming national monument at Klokhuisplein. The elegant cuisine of chefs Mark Gratama is daring due to the exciting combination of flavours.', 'Klokhuisplein 9, 2011 HK Haarlem', 'Dutch, Fish and Seafood, European', 'Vegetarian Friendly, Vegan Options, Gluten Free Options', '');
...
INSERT INTO `sessionRestaurant` (`sessionId`, `startTime`, `endTime`, `date`, `capacity`, `reservationPrice`, `sessionPrice`, `reducedPrice`, `restaurantId`) VALUES
                                                                                                                                                                  (3, '17:00:00.000000', '19:00:00.000000', '2023-07-27', 40, 10, 45, 22.5, 1),
                                                                                                                                                                  (4, '19:00:00.000000', '21:00:00.000000', '2023-07-27', 40, 10, 45, 22.5, 1),
                                                                                                                                                                  (6, '11:01:00.000000', '11:02:00.000000', '1990-01-13', 1, 1, 1, 0, 1);
...
--
ALTER TABLE `reservation`
    ADD CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`sessionId`) REFERENCES `sessionRestaurant` (`sessionId`),
  ADD CONSTRAINT `reservation_ibfk_2` FOREIGN KEY (`restaurantName`) REFERENCES `restaurant` (`name`);

--
-- Constraints for table `sessionRestaurant`
--
ALTER TABLE `sessionRestaurant`
    ADD CONSTRAINT `sessionRestaurant_ibfk_1` FOREIGN KEY (`restaurantId`) REFERENCES `restaurant` (`id`) ON DELETE CASCADE;
COMMIT;
